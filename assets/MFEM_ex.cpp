...
int main(int argc, char* argv[])
{
   ...
   /* Eigen::JacobiSVD<Eigen::MatrixXd> svd(Ae);
    ...
    /*cout << "hello3" << endl;
    cout << "shape A: (" << Ae.rows() << "," << Ae.cols() << ")\n";
    cout << "shape B: (" << Be.rows() << "," << Be.cols() << ")\n";*/
 /*   Eigen::FullPivLU<Eigen::MatrixXd> lu_decomp(Ae);
    ...
    GSSmoother M(A);
    PCG(A, M, B, X, 1, 50000, 1e-8, 0.0);

    clock_t end2 = clock();
    float elapsed_secs2 = float(end2 - begin2) / CLOCKS_PER_SEC;
    cout << endl<<"+++++++++++++++++++++++++++++" << endl;
    std::cout << "direct solver time taken: " << elapsed_secs2 << std::endl;
    cout  << "+++++++++++++++++++++++++++++" << endl;
    ...
    cout << "PCG SOLVER:" << endl;
    //x.Print();
    cout << "PCG SOLVER:" << endl;

    //cout << "L1 norm: " << diff.Norml1() << endl;
