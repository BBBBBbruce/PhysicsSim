...
//
// $URL: https://github.com/CGAL/cgal/blob/v5.3/Installation/include/CGAL/internal/enable_third_party_libraries.h $
...
#pragma message("<gmp.h> cannot be found. Less efficient number types will be used instead. Define CGAL_NO_GMP=1 if that is on purpose.")
#    undef CGAL_USE_GMP
#    undef CGAL_USE_MPFR
